...
var SettingsComponent = /** @class */ (function (_super) {
    ...
    SettingsComponent.prototype.getSubscribedInterests = function () {
        return __awaiter(this, void 0, void 0, function () {
            var interests;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, PusherBeams.getDeviceInterests()];
                    case 1:
                        interests = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.getSubscribedInterests()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    SettingsComponent.prototype.unsubscribeInterest = function (text) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, PusherBeams.removeDeviceInterest({ interest: text })];
                    case 1:
                        s = _a.sent();
    ...
    SettingsComponent.prototype.clearDeviceInterests = function () {
        return __awaiter(this, void 0, void 0, function () {
            var s;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, PusherBeams.clearDeviceInterests()];
                    case 1:
                        s = _a.sent();
    ...
    SettingsComponent.prototype.clearAllPusherState = function () {
        return __awaiter(this, void 0, void 0, function () {
            var s;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, PusherBeams.clearAllState()];
                    case 1:
                        s = _a.sent();
